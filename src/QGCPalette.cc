...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(windowShadeLight, "#707070", "#626262", "#707070", "#626262")
    DECLARE_QGC_COLOR(windowShade, "#d9d9d9", "#d9d9d9", "#333333", "#333333")
    DECLARE_QGC_COLOR(windowShadeDark, "#bdbdbd", "#bdbdbd", "#2c2c2c", "#000000")
    DECLARE_QGC_COLOR(text, "#9d9d9d", "#000000", "#707070", "#ffffff")
    DECLARE_QGC_COLOR(warningText, "#cc0808", "#cc0808", "#d80000", "#d80000")
    DECLARE_QGC_COLOR(button, "#393956", "#575782", "#393956", "#575782")
    DECLARE_QGC_COLOR(buttonText, "#a6a6a6", "#000000", "#a6a6a6", "#ffffff")
    DECLARE_QGC_COLOR(buttonHighlight, "#0095D9", "#00ABF4", "#0095D9", "#00ABF4")
    DECLARE_QGC_COLOR(buttonHighlightText, "#2c2c2c", "#ffffff", "#2c2c2c", "#000000")
    DECLARE_QGC_COLOR(primaryButton, "#585858", "#8cb3be", "#585858", "#00587d")
    DECLARE_QGC_COLOR(primaryButtonText, "#2c2c2c", "#000000", "#2c2c2c", "#000000")
    DECLARE_QGC_COLOR(textField, "#707070", "#ffffff", "#707070", "#ffffff")
    DECLARE_QGC_COLOR(textFieldText, "#808080", "#000000", "#000000", "#000000")
    DECLARE_QGC_COLOR(mapButton, "#585858", "#000000", "#585858", "#000000")
    DECLARE_QGC_COLOR(mapButtonHighlight, "#585858", "#0084bc", "#585858", "#0084bc")
    ...
    DECLARE_QGC_COLOR(colorBlue, "#0084bd", "#008fcc", "#0084bd", "#008fcc")
    DECLARE_QGC_COLOR(alertBackground, "#ea9c00", "#d9906c", "#ea9c00", "#d9906c")
    DECLARE_QGC_COLOR(alertBorder, "#808080", "#808080", "#000000", "#000000")
    DECLARE_QGC_COLOR(alertText, "#000000", "#000000", "#000000", "#000000")
    DECLARE_QGC_COLOR(missionItemEditor, "#585858", "#585d83", "#585858", "#585d83")
    DECLARE_QGC_COLOR(toolStripHoverColor, "#585858", "#585d83", "#585858", "#585d83")
    ...
    DECLARE_QGC_COLOR(toolbarBackground, "#ffffff", "#ffffff", "#222222", "#000000")
    DECLARE_QGC_COLOR(brandingPurple, "#009adc", "#0084bd", "#009adc", "#0084bd")
    DECLARE_QGC_COLOR(brandingBlue, "#48d6ff", "#0084bd", "#48d6ff", "#0084bd")
    DECLARE_QGC_COLOR(toolStripFGColor, "#707070", "#ffffff", "#707070", "#ffffff")
    DECLARE_QGC_COLOR(mapWidgetBorderLight, "#ffffff", "#ffffff", "#ffffff", "#0095d9")
    DECLARE_QGC_COLOR(mapWidgetBorderDark, "#000000", "#000000", "#000000", "#000000")
    DECLARE_QGC_COLOR(mapMissionTrajectory, "#be781c", "#be781c", "#be781c", "#aa5500")
